// Chapter 1: Vectors and Linear Combinations (Sections 1-4)
...
// Section 2: Dot Products and Lengths
...
export const section04Quiz: QuizQuestion[] = [
  ...
  {
    id: 's04-q4',
    question: 'Which property is NOT true for matrix-vector multiplication?',
    options: ['A(x + y) = Ax + Ay', 'A(cx) = c(Ax)', '(A + B)x = Ax + Bx', 'Ax = xA'],
    correctAnswer: 3,
    difficulty: 'hard',
    explanation: 'Matrix multiplication is not commutative. Ax ≠ xA (xA may not even be defined).'
  }
];
...
export const chapter01Quiz: QuizQuestion[] = [
  ...
  {
    id: 'ch01-q5',
    question: 'If A is m×n and b is m×1, the system Ax = b is called:',
    options: ['Overdetermined if m > n', 'Underdetermined if m > n', 'Always inconsistent', 'Always consistent'],
    correctAnswer: 0,
    difficulty: 'hard',
    explanation: 'More equations than unknowns (m > n) means overdetermined system.'
  },
  {
    id: 'ch01-q6',
    question: 'The column space of A is the set of all possible:',
    options: ['Vectors x', 'Vectors Ax', 'Rows of A', 'Solutions to Ax = 0'],
    correctAnswer: 1,
    difficulty: 'medium',
    explanation: 'The column space C(A) consists of all linear combinations of columns = all Ax.'
  },
  {
    id: 'ch01-q7',
